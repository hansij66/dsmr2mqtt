...
#               DESCRIPTION                                     MQTT_TOPIC  MQTT_TAG                 REGEX               DT       DV   MP      MAX    HA_DISCOVERY
definition = {
...
"0-0:96.7.21":  ["Number of power failures in any phases",       "elec",     "power_failures",        "^.*\((.*)\)",      "int",   "0", "1",    "12",  "1", "mdi:counter"],
"0-0:96.7.9":   ["Number of long power failures in any phases",  "elec",     "long_power_failures",   "^.*\((.*)\)",      "int",   "0", "1",    "12",  "1", "mdi:counter"],
"0-0:96.14.0":  ["Tariff indicator electricity",                 "elec",     "tariff_indicator",      "^.*\((.*)\)",      "int",   "0", "1",    "0",   "1", "mdi:counter"],

"1-0:21.7.0":   ["Instantaneous active power L1 +P [kW]",        "elec",     "P_L1_consumed",         "^.*\((.*)\*kW\)",  "float", "0", "1000", "60",  "0", "mdi:gauge"],
"1-0:41.7.0":   ["Instantaneous active power L2 +P [kW]",        "elec",     "P_L2_consumed",         "^.*\((.*)\*kW\)",  "float", "0", "1000", "60",  "0", "mdi:gauge"],
"1-0:61.7.0":   ["Instantaneous active power L3 +P [kW]",        "elec",     "P_L3_consumed",         "^.*\((.*)\*kW\)",  "float", "0", "1000", "60",  "0", "mdi:gauge"],
"1-0:22.7.0":   ["Instantaneous active power L1 -P [kW]",        "elec",     "P_L1_produced",         "^.*\((.*)\*kW\)",  "float", "0", "1000", "60",  "0", "mdi:gauge"],
"1-0:42.7.0":   ["Instantaneous active power L2 -P [kW]",        "elec",     "P_L2_produced",         "^.*\((.*)\*kW\)",  "float", "0", "1000", "60",  "0", "mdi:gauge"],
"1-0:62.7.0":   ["Instantaneous active power L3 -P [kW]",        "elec",     "P_L3_produced",         "^.*\((.*)\*kW\)",  "float", "0", "1000", "60",  "0", "mdi:gauge"],
"1-0:1.7.0":    ["Actual electricity power delivered +P [kW]",   "elec",     "P_consumed",            "^.*\((.*)\*kW\)",  "float", "0", "1000", "60",  "1", "mdi:gauge"],
"1-0:2.7.0":    ["Actual electricity power received -P [kW]",    "elec",     "P_produced",            "^.*\((.*)\*kW\)",  "float", "0", "1000", "60",  "1", "mdi:gauge"],
...
"1-0:52.7.0":   ["Instantaneous voltage L2 [V]",                 "elec",     "V_L2",                  "^.*\((.*)\*V\)",   "float", "0", "1",    "60",  "1", "mdi:gauge"],
"1-0:72.7.0":   ["Instantaneous voltage L3 [V]",                 "elec",     "V_L3",                  "^.*\((.*)\*V\)",   "float", "0", "1",    "60",  "1", "mdi:gauge"],
"1-0:31.7.0":   ["Instantaneous current L1 [A]",                 "elec",     "I_L1",                  "^.*\((.*)\*A\)",   "int",   "0", "1",    "0",   "0", "mdi:gauge"],
"1-0:51.7.0":   ["Instantaneous current L2 [A]",                 "elec",     "I_L2",                  "^.*\((.*)\*A\)",   "int",   "0", "1",    "0",   "0", "mdi:gauge"],
"1-0:71.7.0":   ["Instantaneous current L3 [A]",                 "elec",     "I_L3",                  "^.*\((.*)\*A\)",   "int",   "0", "1",    "0",   "0", "mdi:gauge"],

"1-0:32.36.0":  ["Number of voltage swells L1",                  "elec",     "V_L1_swells",           "^.*\((.*)\)",      "int",   "0", "1",    "12",  "0", "mdi:gauge"],
"1-0:52.36.0":  ["Number of voltage swells L2",                  "elec",     "V_L2_swells",           "^.*\((.*)\)",      "int",   "0", "1",    "12",  "0", "mdi:gauge"],
"1-0:72.36.0":  ["Number of voltage swells L3",                  "elec",     "V_L3_swells",           "^.*\((.*)\)",      "int",   "0", "1",    "12",  "0", "mdi:gauge"],
"1-0:32.32.0":  ["Number of voltage sags L1",                    "elec",     "V_L1_sags",             "^.*\((.*)\)",      "int",   "0", "1",    "12",  "0", "mdi:gauge"],
"1-0:52.32.0":  ["Number of voltage sags L2",                    "elec",     "V_L2_sags",             "^.*\((.*)\)",      "int",   "0", "1",    "12",  "0", "mdi:gauge"],
"1-0:72.32.0":  ["Number of voltage sags L3",                    "elec",     "V_L3_sags",             "^.*\((.*)\)",      "int",   "0", "1",    "12",  "0", "mdi:gauge"]
}
